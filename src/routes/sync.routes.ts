...
// Run this alongside /sync/prices/cardmarket for full coverage:
//   pokemontcg.io → TCGPlayer USD prices per variant (normal, reverseHolofoil etc)
//   CardMarket    → EUR prices + PSA/BGS/eBay graded prices
