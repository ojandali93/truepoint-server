...
router.post('/:setId/cards/:cardId/toggle',  writeLimiter,    MC.toggleCardCollected as any);

// PUT  /api/v1/master-sets/:setId/cards/:cardId/quantity — set quantity (dupes)
router.put('/:setId/cards/:cardId/quantity', writeLimiter,    MC.setCardQuantity as any);
